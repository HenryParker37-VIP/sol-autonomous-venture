...
def dashboard_snapshot() -> dict:
    with connect() as c:
        ...
        acquisition_metrics = {"external_posts_published": event_counts.get("EXTERNAL_POST_PUBLISHED", 0), "outreach_sent": event_counts.get("OUTREACH_SENT", 0), "replies_received": event_counts.get("REPLY_RECEIVED", 0), "referral_visits": referral_visits, "cta_clicks": cta_clicks, "orders_created": funnel["orders"]}
